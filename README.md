...
4,182 employers tracked · updated Aug 22, 2026 at 06:51 UTC
...
_Engine (last run): 2,777 of 4,285 registered boards returned successfully across 12 ATS platforms (68% of boards attempted, 64% of the full registry) · completed in 173.8s · 28 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
