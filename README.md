...
### 246 open roles (218 listed below) · 75 new this week

4,193 employers tracked · updated Aug 24, 2026 at 22:38 UTC

_150 have a cycle the employer stated · 96 are recent postings whose cycle isn't stated (listed separately, never mixed in)._
...
| Bloomberg | ~Sep | ~Sep · in ~8d | ⏳ waiting |
| Dropbox | ~Sep | ~Sep · in ~8d | ⏳ waiting |
| Plaid | ~Sep | ~Sep · in ~8d | ⏳ waiting |
| Point72 | ~Sep | ~Sep · in ~8d | ⏳ waiting |
| Robinhood | ~Sep | ~Sep · in ~8d | ⏳ waiting |
| Stripe | ~Sep | ~Sep · in ~8d | ⏳ waiting |
| D.E. Shaw | ~Oct | ~Oct · in ~38d | ⏳ waiting |
...
_Engine (last run): 4,029 of 4,296 registered boards returned successfully across 12 ATS platforms (100% of boards attempted, 93% of the full registry) · completed in 389.7s · 104 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
