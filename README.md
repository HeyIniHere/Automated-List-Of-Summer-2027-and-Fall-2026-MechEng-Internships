...
### 230 open roles (202 listed below) · 69 new this week

4,193 employers tracked · updated Aug 23, 2026 at 12:57 UTC

_138 have a cycle the employer stated · 92 are recent postings whose cycle isn't stated (listed separately, never mixed in)._
...
| Bloomberg | ~Sep | ~Sep · in ~9d | ⏳ waiting |
| Dropbox | ~Sep | ~Sep · in ~9d | ⏳ waiting |
| Plaid | ~Sep | ~Sep · in ~9d | ⏳ waiting |
| Point72 | ~Sep | ~Sep · in ~9d | ⏳ waiting |
| Robinhood | ~Sep | ~Sep · in ~9d | ⏳ waiting |
| Stripe | ~Sep | ~Sep · in ~9d | ⏳ waiting |
| D.E. Shaw | ~Oct | ~Oct · in ~39d | ⏳ waiting |
...
_Engine (last run): 3,965 of 4,296 registered boards returned successfully across 12 ATS platforms (98% of boards attempted, 92% of the full registry) · completed in 421.1s · 91 board(s) returned a capped result set, so their roles were not eligible to be closed this run · employer or source-derived date on 100% of open roles._
